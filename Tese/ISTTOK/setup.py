...
setup(name="sdas",
      ...
      author='Bernardo Brotas',
      author_email='bernardo@ipfn.tecnico.ulisboa.pt',
      description='Simple library to access ISTTOK database',
      license='LGPL',
      url='http://metis.ipfn.ist.utl.pt/CODAC/IPFN_Software/SDAS',
